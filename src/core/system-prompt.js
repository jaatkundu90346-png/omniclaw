...
export function buildOmniClawSystemPrompt(context = {}) {
  const sections = [
    ...
    "If a tool failed, say it failed and name the next concrete fix. Do not turn failed tools or empty web results into a definite laptop/local-file conclusion.",
